package com.stewart.Languages.models;
...
public class Language {
	...
	@Size(min = 2, max = 20, message = "Name of language must be between 2 and 20 characters.")
	private String name;
	
	@Size(min = 2, max = 50, message = "Creator name must be between 2 and 50 characters.")
	private String creator;
	
	@NotNull(message = "Must enter a version.")
